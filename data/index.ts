...
export const gridItems = [
  {
    id: 1,
    title: "I try to stay up to date and constantly improve my skills.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building a Finance Management App with Next.js and Plaid",
...
export const projects = [
  ...
  },
  {
    ...
    des: "Simplify your video conferencing experience with Vroom. Seamlessly connect with colleagues and friends.",
    img: "/pr2.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/stream.svg", "/c.svg"],
    link: "https://github.com/mhbagheri-99/vroom",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    des: "Plan and manage your events with ease. Evently is the perfect solution for all your event planning needs.",
    img: "/pr4.png",
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/next.svg", "/stripe.svg"],
    link: "https://github.com/mhbagheri-99/Evently",
  },
];
...
export const workExperience = [
  {
    ...
    desc: "Ready to make web app platforms to satisfy the client needs.",
  ...
  {
    id: 3,
    title: "Python Tutor and Developer",
    desc: "Empowered students in Python programming through tutoring and helped building a solid curriculum.",
  ...
  },
  {
    ...
    desc: "Developing and self-publishing games using Unreal Engine and C++",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
